...
public class GetAggregatedLaboratoryOrderOutComeMuleServer {


	public static final String MULE_SERVER_ID   = "GetAggregatedLaboratoryOrderOutCome";
	...
	public static void main(String[] args) throws Exception {
        ...
        //         Note: Actually enables the spring-beans-profile "soitoolkit-teststubs" in the file "src/main/app/GetAggregatedLaboratoryOrderOutCome-common.xml"
        //
